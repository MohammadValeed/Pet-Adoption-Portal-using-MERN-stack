...
export default function Footer() {
    return (
        <div className='max-w-screen-2xl container mx-auto  h-[80px] '>
            <footer className="footer p-10 bg-neutral text-neutral-content ">
                <nav>
                    <h1 className="text-white text-5xl font-bold">Petzee</h1>
                    <a className="link link-hover text-white text-3xl">Petzee's Industries Ltd</a>
                    <a className="link link-hover text-white text-2xl">Hassan , Karnataka</a>
            ...
            <p className='text-center py-5 bg-neutral  text-white text-xl'>Copyright © 2024 - All right reserved by Petzee Team. </p>
        </div>
    )
}
